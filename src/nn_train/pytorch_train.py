...
def visualize(predicted_data, real_data, logfile, x_test,loss1,loss2):
    data_dir = '/home/robot/workspaces/ur5_mpc_vrep/logs/'
    os.chdir(data_dir)
...
if __name__ == '__main__':
    ...
    # Data loading:
    data_dir = '/home/robot/workspaces/ur5_mpc_vrep/data_1210/'
    os.chdir(data_dir)
    ...
    test_data = np.loadtxt('data_BA_554.csv', skiprows = 1,delimiter=',')
