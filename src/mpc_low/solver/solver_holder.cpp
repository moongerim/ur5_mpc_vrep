...
double * MPC_solver::solve_mpc(double input_arr[68], double state_arr[60]) {
	...
	*/
	...
	double human_spheres[] = {input_arr[12], input_arr[13], input_arr[14], input_arr[15], input_arr[16], 
							  ...
							  input_arr[62], input_arr[63], input_arr[64], input_arr[65], input_arr[66], input_arr[67]};
