...
/** Column vector of size: 12024 */
real_t conAuxVar[ 12024 ];

/** Row vector of size: 73 */
real_t conValueIn[ 73 ];

/** Row vector of size: 2175 */
real_t conValueOut[ 2175 ];

/** Column vector of size: 1450 */
real_t evH[ 1450 ];

/** Matrix of size: 1450 x 7 (row major format) */
real_t evHx[ 10150 ];
...
/** Column vector of size: 1450 */
real_t pacA01Dx0[ 1450 ];

/** Matrix of size: 70 x 70 (row major format) */
real_t H[ 4900 ];

/** Matrix of size: 1450 x 70 (row major format) */
real_t A[ 101500 ];
